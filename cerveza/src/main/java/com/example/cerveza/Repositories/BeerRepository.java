...
public class BeerRepository {
    ...
    public static List<BeerModel> sacarTodasBeer(){ //Este método saca todas las cervezas de la BD usando el rowmapper
    ...
    public static void insertarBeer(BeerModel beer){ //Este método recibe un objeto de la clase BeerModel y lo inserta en la BD
        jdbcTemplate.update("INSERT INTO beer (nombre, anoLanzamiento, brewery_new, brewery_old) VALUES (?, ?, ?, ?)", beer.getNombre(), beer.getAnoLanzamiento(), beer.getCodigoBreweryNew(), beer.getCodigoBreweryOld());
    }
